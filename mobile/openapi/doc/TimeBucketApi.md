...
# **getByTimeBucket**
> List<AssetResponseDto> getByTimeBucket(size, timeBucket, userId, isArchived, isFavorite)
...
try {
    final result = api_instance.getByTimeBucket(size, timeBucket, userId, isArchived, isFavorite);
    print(result);
} catch (e) {
...
# **getTimeBuckets**
> List<TimeBucketResponseDto> getTimeBuckets(size, userId, isArchived, isFavorite)
...
try {
    final result = api_instance.getTimeBuckets(size, userId, isArchived, isFavorite);
    print(result);
} catch (e) {
