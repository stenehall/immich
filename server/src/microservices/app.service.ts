...
export class AppService {
  ...
  async init() {
    await this.jobService.registerHandlers({
      ...
      [JobName.QUEUE_GENERATE_THUMBNAILS]: (data) => this.thumbnailService.handleQueueGenerateThumbnails(data),
      [JobName.GENERATE_JPEG_THUMBNAIL]: (data) => this.thumbnailService.handleGenerateJpegThumbnail(data),
      [JobName.GENERATE_WEBP_THUMBNAIL]: (data) => this.thumbnailService.handleGenerateWepbThumbnail(data),
      [JobName.GENERATE_THUMBHASH_THUMBNAIL]: (data) => this.thumbnailService.handleGenerateThumbhashThumbnail(data),
      [JobName.QUEUE_VIDEO_CONVERSION]: (data) => this.transcodeService.handleQueueVideoConversion(data),
      [JobName.VIDEO_CONVERSION]: (data) => this.transcodeService.handleVideoConversion(data),
