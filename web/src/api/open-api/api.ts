...
export const TimeBucketApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async getTimeBuckets(
			...
			(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<TimeBucketResponseDto>>
		> {
 ...
 * @export
 */
export const TimeBucketApiFactory = function (
	configuration?: Configuration,
	basePath?: string,
	axios?: AxiosInstance
) {
	...
	return {
		...
		getByTimeBucket(
			...
			return localVarFp
				.getByTimeBucket(size, timeBucket, userId, albumId, isArchived, isFavorite, key, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
		...
		getTimeBuckets(
			...
			return localVarFp
				.getTimeBuckets(size, userId, albumId, isArchived, isFavorite, key, options)
				.then((request) => request(axios, basePath));
		}
	};
};
...
export class TimeBucketApi extends BaseAPI {
	...
	public getByTimeBucket(
		...
		return TimeBucketApiFp(this.configuration)
			.getByTimeBucket(size, timeBucket, userId, albumId, isArchived, isFavorite, key, options)
			.then((request) => request(this.axios, this.basePath));
	}
